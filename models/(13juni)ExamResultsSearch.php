...
class ExamResultsSearch extends ExamResults
{
    ...
    {
        return [
            [['id', 'exam_id', 'student_id', 'skor', 'jlh_benar_essay', 'jlh_benar_pilgan', 'skor_essay', 'skor_pilgan'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'jlh_benar_essay' => $this->jlh_benar_essay,
            'jlh_benar_pilgan' => $this->jlh_benar_pilgan,
            'tgl_mulai' => $this->tgl_mulai,
            'skor_essay' => $this->skor_essay,
            'skor_pilgan' => $this->skor_pilgan,
        ]);
