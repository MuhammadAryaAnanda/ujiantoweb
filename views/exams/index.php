...
/** @var app\models\ExamsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Jenis Ujian';
?>
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tabel Jenis Ujian</li>
            </ol>
        </nav>
    </div>
</div>
<h6 class="mb-0 text-uppercase">Tabel Jenis Ujian</h6>
<hr />
<p>
    <?= Html::a('Tambah Jenis Ujian', ['create'], ['class' => 'btn btn-success']) ?>
</p>
<div class="card">
    <div class="card-body">
        <table id="example2" class="display nowrap table table-striped table-hover dataTable dtr-column"
            ...
            <thead>
                <tr>
                    ...
                    <!-- <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Tanggal Pelaksanaan Ujian</th>
                    <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Tangal Selesai Ujian</th> -->
                    <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Durasi Pengerjaan</th>
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td><?= $index + 1 ?></td>
                    <td><?= Html::encode($model->nama_ujian) ?></td>
                    <td><?= Html::encode($model->bidang->nama) ?></td>
                    <!-- <td><?php //= Html::encode($model->keterangan_ujian)
                    ?></td> -->
                    <!-- <td><?php //= Html::encode($model->tanggal_pelaksanaan_ujian) ?></td>
                    <td><?php //= Html::encode($model->tanggal_selesai_ujian) ?></td> -->
                    <td><?= Html::encode($model->durasi_pengerjaan_ujian) ?></td>
                    <!-- <td><?php //= Html::encode($model->jlh_soal) ?></td> -->
                    <td>
