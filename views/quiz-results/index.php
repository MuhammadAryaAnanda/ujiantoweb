...
/** @var app\models\QuizResultsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Jawaban Pilgan Peserta';
?>
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tabel Jawaban Pilgan Peserta</li>
            </ol>
        </nav>
    </div>
</div>
<h6 class="mb-0 text-uppercase">Tabel Jawaban Pilgan Peserta</h6>
<hr />
<div class="card">
    <div class="card-body">
        <table id="example2" class="display nowrap table table-striped table-hover dataTable dtr-column"
            ...
            <thead>
                <tr>
                    ...
                    <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Keterangan</th>
                    ...
                    <!-- <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Age</th>
                        <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Start date</th>
                        <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Salary</th> -->
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td><?= $index + 1 ?></td>
                    <td><?= Html::encode($model->student ? $model->student->name : 'N/A') ?></td>
                    <!-- <td>exams->nama_ujian</td> -->
                    <td><?= Html::encode($model->answers ? $model->answers->jawaban : 'N/A') ?></td>
                    <td><?= Html::encode($model->answers ? ($model->answers->benar ? 'benar' : 'salah') : 'N/A') ?></td>
                    ...
                    <!-- <td> -->
                        ...
                        <!-- <div class="table-actions d-flex align-items-center gap-3 fs-6"> -->
                            ...
                            <?php //= Html::a('<i class="bi bi-pencil-fill text-warning"></i>', ['update', 'id' => $model->id], ['data-bs-toggle' => 'tooltip', 'data-bs-placement' => 'bottom', 'title' => 'Edit'])?>
            ...
            <!-- <tfoot>
                    <tr>
                        ...
                        <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Created At</th>
                        <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Aksi</th> -->
            <!-- <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Office</th> -->
            <!-- <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Start date</th>
                        <th class="dt-orderable-asc dt-orderable-desc dt-ordering-asc">Salary</th> -->
            <!-- </tr>
                </tfoot> -->
