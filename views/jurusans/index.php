...
/** @var app\models\JurusansSearch $searchModel */
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tabel Jurusan</li>
            </ol>
        </nav>
    </div>
</div>
<h6 class="mb-0 text-uppercase">Tabel Jurusan</h6>
<hr />
<p>
        ...
        <table id="example2" class="display nowrap table table-striped table-hover dataTable dtr-column"
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td><?= $index + 1 ?></td>
                    <td><?= Html::encode($model->nama_jurusan) ?></td>
                    <td>
