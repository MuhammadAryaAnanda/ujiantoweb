...
/** @var app\models\JurusanBidangSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Jurusan-Bidang';
?>
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tabel Relasi Jurusan-Bidang</li>
            </ol>
        </nav>
    </div>
</div>
<h6 class="mb-0 text-uppercase">Relasi Jurusan Bidang</h6>
<hr />
<p>
        ...
        <table id="example2" class="display nowrap table table-striped table-hover dataTable dtr-column"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= Html::encode($model->jurusan->nama_jurusan) ?></td>
                    <td>
