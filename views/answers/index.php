    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tabel Jawaban Pilihan Berganda</li>
            </ol>
        </nav>
    </div>
    <!-- <div class="ms-auto">
...
<h6 class="mb-0 text-uppercase">Tabel Jawaban Pilihan Berganda</h6>
<hr />
<p>
        ...
        <table id="example2" class="display nowrap table table-striped table-hover dataTable dtr-column"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $model->benar == 1 ? 'Benar' : 'Salah' ?></td>
