                ...
                <tbody>
                    <?php foreach ($dataProvider->models as $index => $model) : ?>
                            <tr>
                                ...
                                <td><?= Html::encode($model->keterangan_ujian) ?></td>
                                <td><?= Html::encode($model->tanggal_pelaksanaan_ujian) ?></td>
                                <td><?= Html::encode($model->tanggal_selesai_ujian) ?></td>
                                <td><?= Html::encode($model->durasi_pengerjaan_ujian) ?></td>
                                <td><?= Html::encode($model->administrator->name) ?></td>
                                <td>
