                ...
                <tbody>
                    <?php foreach ($dataProvider->models as $index => $model) : ?>
                            <tr>
                                ...
                                <td><?= Html::encode($model->penempatan_bidang) ?></td>
                                ...
                                <td><?= Html::encode($model->jurusan) ?></td>
                                <td><?= Html::encode($model->photo) ?></td>
                                <td>
                                    ...
                                    <?= Html::a('<i class="bi bi-trash-fill"></i>', '#', [
                                        ...
                                        'data-url' => Url::to(['students/delete', 'id' => $model->id]),
                                    ]) ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
