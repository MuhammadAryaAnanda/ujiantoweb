...
$this->title = 'Data Jawaban Peserta';
?>
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tabel Jawaban Peserta</li>
            </ol>
        </nav>
    </div>
    <div class="ms-auto">
...
<h6 class="mb-0 text-uppercase">Tabel Jawaban Peserta</h6>
<hr/>
<p>
    <?= Html::a('Tambah Jawaban Peserta', ['create'], ['class' => 'btn btn-success']) ?>
</p>
<div class="card">
    <div class="card-body">
                ...
                <tbody>
                    <?php foreach ($dataProvider->models as $index => $model) : ?>
                            <tr>
                                ...
                                <td><?= Html::encode($model->answers) ?></td>
