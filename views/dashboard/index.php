        ...
        <div class="col">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div>
                        <h3 class="card-title"><?= $mentorCount ?></h3>
                    </div>
                    <p class="card-text">Mentor</p>
                    <a href="/mentors" class="btn btn-primary px-5">More info <i class="lni lni-chevron-right-circle"></i></a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <a href="/students" class="btn btn-primary px-5">More info <i class="lni lni-chevron-right-circle"></i></a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div>
                        <h3 class="card-title"><?= $questionCount ?></h3>
                    </div>
                    <p class="card-text">Soal</p>
                    <a href="/questions" class="btn btn-primary px-5">More info <i class="lni lni-chevron-right-circle"></i></a>
                </div>
            </div>
        </div>
</div>
            ...
            <div class="card">
                <div class="card-body text-center">
                  <div class="widget-icon mx-auto mb-3 bg-light-purple text-purple">
                    ...
                    <div>
                        <h3 class="card-title"><?= $jurusanCount ?></h3>
                    </div>
                    <p class="card-text">Jurusan</p>
                    <a href="/jurusans" class="btn btn-primary px-5">More info <i class="lni lni-chevron-right-circle"></i></a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <div class="card-body text-center">
                  <div class="widget-icon mx-auto mb-3 bg-light-orange text-orange">
                    ...
                    <div>
                        <h3 class="card-title"><?= $bidangCount ?></h3>
                    </div>
                    <p class="card-text">Bidang</p>
                    <a href="/bidangs" class="btn btn-primary px-5">More info <i class="lni lni-chevron-right-circle"></i></a>
                </div>
            </div>
        </div>
        <div class="col">
            <!-- <div class="card">
                <div class="card-body text-center">
                    ...
                    <div>
                        <h3 class="card-title"><?php //= $questionCount ?></h3>
                    </div>
                    <p class="card-text">Soal</p>
                    <a href="/questions" class="btn btn-primary px-5">More info <i class="lni lni-chevron-right-circle"></i></a>
                </div>
