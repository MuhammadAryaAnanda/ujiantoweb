...
use app\models\ExamResultsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ExamResultssController implements the CRUD actions for ExamResults model.
 */
class ExamResultssController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    {
        if (($model = ExamResults::findOne(['id' => $id])) !== null) {
            return $model;
        }
